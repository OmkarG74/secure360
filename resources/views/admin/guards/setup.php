...
<div class="breadcrumb" style="font-size: 0.8125rem; color: #64748b; margin-bottom: 1rem;">
    ...
    <span style="color: #0f172a; font-weight: 500;">Setup Guard</span>
</div>

<div class="page-header" style="margin-bottom: 2rem;">
    <h1 style="font-size: 1.625rem; font-weight: 700; color: #0f172a; margin-bottom: 0.25rem;">Guard Setup</h1>
    <p style="font-size: 0.875rem; color: #64748b;">Create profile, assign credentials and operational parameters for mobile Flutter duty.</p>
</div>

<?php App\Core\View::component('components/alerts'); ?>

<form method="POST" action="<?= url('/admin/guards/setup') ?>" enctype="multipart/form-data">
    <?= csrf_field() ?>
            ...
            <div class="card" style="padding: 1.75rem; text-align: center;">
                ...
                <div id="dropzoneContainer" style="border: 2px dashed #cbd5e1; border-radius: 12px; padding: 2rem 1rem; background: #f8fafc; cursor: pointer; transition: all 0.2s ease; position: relative;" onclick="document.getElementById('guardPhotoInput').click();">
                    ...
                    <div id="dropzonePreview" style="display: none;">
                        <img id="previewImage" src="" alt="Guard Preview" style="width: 120px; height: 120px; border-radius: 50%; object-fit: cover; margin: 0 auto 0.75rem auto; border: 3px solid #2563eb; display: block;">
            ...
            <div style="display: flex; flex-direction: column; gap: 1.25rem;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div>
                        ...
                        <input type="text" name="employee_code" class="form-control" value="<?= e($nextCode) ?>" readonly style="background: #f8fafc; font-family: monospace; font-weight: 700; color: #2563eb;">
                        <span style="font-size: 0.75rem; color: #94a3b8; margin-top: 0.2rem; display: block;">Auto-generated sequential badge ID</span>
                    </div>
                    <div>
                        <label style="display: block; font-size: 0.8125rem; font-weight: 600; color: #334155; margin-bottom: 0.4rem;">
                            Operational Status
                        ...
                        <select name="status" class="form-control">
                            <option value="0" selected>Active / Deployable</option>
                            <option value="1">Inactive / Suspended</option>
                        </select>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="input-icon-wrapper">
                        ...
                        <input type="text" name="full_name" class="form-control" placeholder="e.g. David Vance" required>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div>
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="guard@apexsecurity.com" required>
                        </div>
                    </div>
                    <div>
                        <label style="display: block; font-size: 0.8125rem; font-weight: 600; color: #334155; margin-bottom: 0.4rem;">
                ...
                <div>
                    <label style="display: block; font-size: 0.8125rem; font-weight: 600; color: #334155; margin-bottom: 0.4rem;">
                        Mobile App Password <span style="color: #ef4444;">*</span>
                    </label>
                    <div class="input-icon-wrapper">
                        ...
                        <input type="password" name="password" class="form-control" placeholder="Create login password for mobile Flutter app" required minlength="6">
                    </div>
                    <span style="font-size: 0.75rem; color: #64748b; margin-top: 0.25rem; display: block;">
                        Minimum 6 characters. The guard will use this email and password to authenticate on the Flutter mobile app.
                    </span>
                </div>
